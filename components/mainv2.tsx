...
* @see https://v0.dev/t/SyaCNtdGcF3
  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 flex justify-center">
          <div className="container px-4 md:px-6 flex justify-center flex-col items-center">
            <div className="space-y-2 text-center">
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Websites We've Built</h2>
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12 justify-center">
              ...
              <div className="flex flex-col justify-center space-y-4 items-center">
                <div className="grid gap-1 text-center">
                  <h3 className="text-xl font-bold">Acme Clothing</h3>
                  <p className="text-muted-foreground">A modern e-commerce website for a leading fashion brand.</p>
                </div>
                <div className="grid gap-1 text-center">
                  <h3 className="text-xl font-bold">Apex Consulting</h3>
                  <p className="text-muted-foreground">
                    A corporate website showcasing the company's services and expertise.
                  </p>
                </div>
                <div className="grid gap-1 text-center">
                  <h3 className="text-xl font-bold">Zen Yoga Studio</h3>
                  <p className="text-muted-foreground">
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t justify-center">
        <p className="text-xs text-muted-foreground">&copy; 2024 Acme Web Development. All rights reserved.</p>
